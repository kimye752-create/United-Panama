...
> **세션 16 / 2026-04-13 마무리 갱신** — 버그 4종 + prevalence 8 INN 완전 통과, 사이트 23개 매트릭스 (DNFD 신규 3개 추가), 절대원칙 18·19 신규, Arrocha 정찰 결과 박제, "실제 INSERT 측정" 원칙 명문화
...
- **LLM**: claude-sonnet-4-5 (ANTHROPIC_API_KEY trim() 적용)
...
│   ├── llm/                      # report1_generator, REPORT1_SYSTEM_PROMPT, perplexity_paper_search (세션 17)
│   ├── logic/                    # case_judgment, fetch_panama_data, prevalence_resolve, freshness_checker, data_reconciler (세션 17), product_matcher (세션 17)
