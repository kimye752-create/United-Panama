...
5. 유통 인프라: 발굴된 4개 파트너 전체 상호 + target_market·3공정 AHP 엔진⑥ PSI 문구. 150~250자.
...
## block2_distribution
- 발굴 파트너 수 + 주요 파트너 상호 + 3공정 AHP 연계
- 예: "발굴 파트너 4개사(Agencias Feduro, Agencias Celmar, C.G. de Haseth, Compañía Astur). 3공정 AHP 엔진⑥ PSI 점수화 예정."
