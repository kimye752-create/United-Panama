...
const COMPETITOR_KEYWORDS_OCDS: readonly CompetitorRuleOcds[] = [
  ...
  {
    atc4: "B01AC",
    selfInn: "Cilostazol + Rosuvastatin",
  ...
  {
    atc4: "C10AA",
    selfInn: "Atorvastatin + Omega-3-acid ethyl esters",
  ...
  {
    atc4: "R03AK",
    selfInn: "Salmeterol + Fluticasone",
    selfProductId: "014fd4d2-dc66-4fc1-8d4f-59695183387f",
    keywords: ["SALMETEROL", "FLUTICASONA", "BUDESONIDA", "FORMOTEROL"],
  },
  {
    atc4: "C10AX",
    selfInn: "Omega-3",
    selfProductId: "f88b87b8-c0ab-4f6e-ba34-e9330d1d4e18",
    keywords: ["OMEGA", "OMEGA-3", "ESTERES ETILICOS"],
  },
  {
    atc4: "V08CA",
    selfInn: "Gadobutrol",
    selfProductId: "895f49ae-6ce3-44a3-93bd-bb77e027ba59",
    keywords: ["GADOBUTROL", "GADOTERIDOL", "GADOPENTETATO"],
  },
];
