  ...
  return (
    <section className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
      {cards.map((card) => (
        ...
        >
          <p className="text-[11px] font-semibold text-[#6a7e98]">{card.label}</p>
          <p className="mt-1 text-[28px] font-black leading-none tracking-[-0.02em] text-[#1f3e64]">
            {card.value}
          </p>
          <p className="mt-1 text-[10.5px] text-[#8b97aa]">
            {card.footer}
