      ...
      <Card title="신약 분석" subtitle="다음 단계에서 연결 예정">
        <div className="grid gap-3 md:grid-cols-[1fr_1fr_1fr_auto]">
          <input
            ...
            className="h-11 rounded-[10px] bg-inner px-3.5 text-[13px] text-text placeholder:text-muted"
          />
          <input
            type="text"
            disabled
          ...
          <button
            type="button"
            disabled
            className="h-11 rounded-[10px] bg-navy/30 px-6 text-[14px] font-bold text-white"
            title="신약 분석은 추후 연결됩니다."
          >
            ▶ 신약 분석
          </button>
        </div>
